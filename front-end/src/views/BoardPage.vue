              ...
              >
                <div class="list">
                  ...
                  >
                    ...
                    >
                      <form
                        @submit.prevent="addCard(cardList)"
                        class="add-card-form"
                      >
                        ...
                        <button
                          type="button"
                          class="btn btn-sm btn-link btn-cancel"
...
export default {
  ...
  methods: {
    dismissActiveForms(event) {
      ...
      if (
        event.target.closest('.add-card-form') ||
        event.target.closest('.add-card-button')
      ) {
        dismissAddCardForm = false
      }
      if (
        event.target.closest('.add-list-form') ||
        event.target.closest('.add-list-button')
      ) {
